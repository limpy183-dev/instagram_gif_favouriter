...
import { SectionCard, ProfileSettings, Page } from '../App';

interface ProfilePageProps {
  workspace: { profile: ProfileSettings; gifMeta: Record<string, { imported: boolean; collectionIds: string[]; tags: string[] }> };
