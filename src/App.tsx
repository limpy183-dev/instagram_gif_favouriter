...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white" style={{ ['--accent' as string]: workspace.profile.accent }}>
      <header className="bg-zinc-950/85 backdrop-blur-xl border-b border-white/5 md:sticky md:top-0 md:z-40">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        {((page === 'favourites' && favouritesLoading) || (page !== 'favourites' && workspaceLoading)) && <div className="masonry-grid">{Array.from({ length: 8 }).map((_, index) => <SkeletonCard key={index} height={[160, 200, 140, 220, 180][index % 5]} />)}</div>}
